---
title: "TreeCarbon: A Complete Workflow Guide"
...
The **TreeCarbon** package provides multiple allometric methods for estimating tree 
biomass and carbon storage. This vignette walks through complete workflows for:
...
| Method | Region | Height Required | Key Reference |
|--------|--------|-----------------|---------------|
...
```{r sensitivity-deviation, fig.height=4}
