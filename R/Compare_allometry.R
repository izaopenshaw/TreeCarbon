...
#   - Method comparison utilities (compare_allometries, compare_methods)
#   - Plotting functions for method evaluation (plot_allometries)
#   - Rich output result classes (allometry_result, create_allometry_result)
#
# Related modules:
#   - method_metadata.R: Method metadata registry and input validation
#   - Sensitivity.R: Sensitivity analysis for method choice
#
...
#'   not provided, it will be estimated using \code{timber_ratio}. Other methods
#'   (BIOMASS, allodb, Bunce) use total height.
...
#'   for broadleaves, will be estimated using \code{timber_ratio}.
